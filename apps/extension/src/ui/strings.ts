...
export const en = {
  ...
  onbPoint1:
    "Passwords, one-time codes, payment and identity fields, and forms that contain them are never saved. Detection is careful but not perfect, so avoid enabling sites where you type highly sensitive prose.",
