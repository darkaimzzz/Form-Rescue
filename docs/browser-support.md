...
| Google Chrome (installed)  | 153.0.8010.53 | Branded Chrome ignores `--load-extension` (since Chrome 137), so it can't be automated this way                                                                                                     | **Not yet exercised — release blocker for v1.0** | —                                                                           |
